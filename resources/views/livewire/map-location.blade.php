    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <form action="{{ route('storedatapenyebaran') }}" method="POST">
                            @csrf
                            <div class="row">
                            <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group" style="color: black;">
                                <label for="birthday" style="color: black;">Tanggal Pelaksanaan</label>
                                <div class="input-group">
                                    <span class="input-group-text">
                                        <svg class="icon icon-xs" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
                                    </span>
                                    <input data-datepicker="" class="form-control" id="birthday" type="text" placeholder="dd/mm/yyyy" required name="tanggal_pelaksanaan">
                                </div>
                            </div>
                            <?php 
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="country" aria-label="Default select example" required name="id_daerah">
                                    <option selected hidden>Nama Kelurahan/Kampung</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jumlah_peserta_vaksin1" class="form-control" placeholder="Peserta Vaksin 1">
                            </div>
                            <div class="form-group">
                                <label>Jumlah Peserta Vaksin 2</label>
                                <input type="text" name="jumlah_peserta_vaksin2" class="form-control" placeholder="Peserta Vaksin 2">
                            </div>
                            <div class="form-group">
                                <label>Jumlah Peserta Vaksin 3</label>
                                <input type="text" name="jumlah_peserta_vaksin3" class="form-control" placeholder="Peserta Vaksin 3">
                            </div>
                            <div class="form-group">
                                <label>Nomor Batch 1</label>
                                <input type="text" name="no_batch1" class="form-control" placeholder="Nomor Batch 1">
                            </div>
                            <div class="form-group">
                                <label>Nomor Batch 2</label>
                                <input type="text" name="no_batch2" class="form-control" placeholder="Nomor Batch 2">
                            </div>
                            <div class="form-group">
                                <label>Nomor Batch 3</label>
                                <input type="text" name="no_batch3" class="form-control" placeholder="Nomor Batch 3">
                            </div>
